...
def evaluate_model(model, X, Y, set_name):
    ...
    Logger.info(
        f"Performance {set_name} set | log_loss : {log_loss_value} | roc_auc_score : {roc_auc_score_value}"
    )
    ...
    confusion_matrix_Logger.info(
        f"confusion_matrix {set_name} | {confusion_matrix_value}"
    )
